...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if ret.enableGasInterceptor:
      ret.gasMaxBP = [0., 9., 35]
      ret.gasMaxV = [0.1, 0.25, 0.35] # [0.2, 0.5, 0.7]
      ret.longitudinalTuning.kpV = [0.15, 0.1, 0.0625] # [1.2, 0.8, 0.5]
      ret.longitudinalTuning.kiV = [0.18, 0.12]
    else:
      ret.gasMaxBP = [0.]
      ret.gasMaxV = [0.25] # [0.5]
      ret.longitudinalTuning.kpV = [0.45, 0.3, 0.1875] # [3.6, 2.4, 1.5]
